...
export default class BoardPresident extends Component {
  ...
  render(props, state) {
    ...
    return <div class="president board">
      ...
      <div class="source">
        <div class="note">*Note: Expected vote is an Associated Press estimate of the share of total ballots cast in an election that have been counted. <a href="https://www.ap.org/about/our-role-in-elections/counting-the-vote">Read more about how EEVP is calculated</a>.</div>
